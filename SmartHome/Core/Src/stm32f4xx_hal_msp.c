...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA8     ------> TIM1_CH1
    */
    HAL_GPIO_DeInit(HC_SR04_OPEN_POSITION_ECO_GPIO_Port, HC_SR04_OPEN_POSITION_ECO_Pin);
  ...
  /* USER CODE END TIM11_MspDeInit 0 */
    ...
    PB9     ------> TIM11_CH1
    */
    HAL_GPIO_DeInit(HC_SR04_CLOSE_POSITION_ECO_GPIO_Port, HC_SR04_CLOSE_POSITION_ECO_Pin);
